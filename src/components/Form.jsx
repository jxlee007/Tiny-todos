...
function Form({ addTodo, toggleForm }) {
    ...
    return (
        <motion.form
            ...
            <h1 className="text-yellow-300 text-2xl mb-4">Add a new task todo</h1>
            ...
            <div className=' w-full flex justify-center gap-6 '>
                <select
                    ...
                    onChange={handleInputChange}
                    className="w-48 h-10 bg-white/90 rounded-xl px-4 mb-4"
                >
            ...
            <button className="w-1/6 h-10 bg-yellow-300 rounded-xl text-white font-bold">Add Todo</button>
            </div>
